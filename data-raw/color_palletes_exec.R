...
###
itv.pv<-c("palevioletred4","darkcyan",
                          "salmon4","steelblue","goldenrod3",
                          "darkgreen", "deeppink4","gray41")

#barplot(rep(1,length(bluepurp)), col=bluepurp, main = "bluepurp")


save(get.out, sorry2botheryou, handmaids, taxi.driver, rando, earthy.forest, earthy.blueyellow, bluepurp, itv.pv, file= here('data', 'color.palletes.rda'))